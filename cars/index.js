...
for (let i = 0; i < carsData.length; i++) {
   ...
   <img src="${carsData[i].picture}" alt="${carsData[i].picture}">
   <li class="textOverly">${carsData[i].brand}</li>
   <li class="textOverly1">${carsData[i].price}</li>
   <li class="textOverly3">${carsData[i].fuel}</li>
   </div>
   `   
}
